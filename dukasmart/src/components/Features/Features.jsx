    ...
    <div className="bg-white py-20" id="features">
      <Section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          <div className="bg-purple-950 p-8 rounded-2xl luxury-card slide-in-left relative overflow-hidden text-white">
            <div className="mb-6">
          ...
          {/* Sales Tracking */}
          <div className="bg-purple-950 p-8 rounded-2xl luxury-card scale-in relative overflow-hidden text-white">
            <div className="mb-6">
          ...
          {/* Customer Insights */}
          <div className="bg-purple-950 p-8 rounded-2xl luxury-card slide-in-right relative overflow-hidden text-white">
            <div className="mb-6">
          ...
          <div className="md:col-span-2 bg-purple-950 p-8 rounded-2xl luxury-card fade-in relative overflow-hidden text-white">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                  <p className="text-purple-200 text-sm">Smart expense categorization with budget tracking and cost optimization</p>
                </div>
              </div>
